...
import ApplicationAccountsCreate from "pages/ApplicationAccountCreate";
import ApplicationAccounts from "pages/ApplicationAccounts";
...
const authenticatedRoutes: RouterRule[] = [
  ...
  { path: Route.applicationAccounts, element: <ApplicationAccounts /> },
  {
    path: Route.applicationAccountsNew,
    element: <ApplicationAccountsCreate />,
  },
