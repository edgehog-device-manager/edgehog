...
const fieldExplanations = defineMessages({
  ...
  restartPolicyMaximumRetryCountTitle: {
    id: "forms.fieldExplanation.restartPolicyMaximumRetryCount.title",
    defaultMessage: "Restart Policy Max Retry Count",
  },
  restartPolicyMaximumRetryCountDescription: {
    id: "forms.fieldExplanation.restartPolicyMaximumRetryCount.description",
    defaultMessage:
      "Maximum number of restart attempts, used with the 'on-failure' restart policy.",
  },
  restartPolicyMaximumRetryCountExample: {
    id: "forms.fieldExplanation.restartPolicyMaximumRetryCount.example",
    defaultMessage: "5",
  },
  networkModeTitle: {
  ...
  storageOptsTitle: {
    id: "forms.fieldExplanation.storageOpts.title",
    defaultMessage: "Storage Options",
  },
  storageOptsDescription: {
    id: "forms.fieldExplanation.storageOpts.description",
    defaultMessage:
      "Driver-specific storage options, such as limiting the size of the writable layer.",
  },
  storageOptsExample: {
    id: "forms.fieldExplanation.storageOpts.example",
  ...
  deviceMappingsExample: {
    ...
    defaultMessage:
      '[ \'{\' pathOnHost:"/dev/sda1", pathInContainer:"/dev/storage", cgroupPermissions:"rwm"\'}\' ]',
  },
  driverTitle: {
  ...
  commandExample: {
    ...
    defaultMessage: "python server.py --host 0.0.0.0",
  },
  entrypointTitle: {
  ...
  dnsOptionsDescription: {
    ...
    defaultMessage: "Options passed to the container's DNS resolver.",
  },
  dnsOptionsExample: {
  ...
  cpusetCpusDescription: {
    ...
    defaultMessage:
      "CPUs on which the container is allowed to execute, as comma-separated individual CPUs or ranges.",
  },
  cpusetCpusExample: {
  ...
  deviceCgroupRulesDescription: {
    ...
    defaultMessage:
      "Device cgroup rules controlling device access for the container.",
  },
  ...
  logTypeDescription: {
    ...
    defaultMessage:
      "The logging driver used by the container, or 'none' to disable logging.",
  },
  logTypeExample: {
