...
import { FieldExplanationSidebar } from "../components/FieldExplanationSidebar";
...
const ContainerForm = ({
  ...
  return (
    <div className="d-flex">
      <div
        className="flex-grow-1 border p-3 mb-3"
      ...
      >
        ...
        <Stack gap={2}>
          ...
          >
            <div
              onFocus={() => setActiveField("extraHosts")}
              onBlur={() => setActiveField(null)}
            >
              <Controller
                control={control}
          ...
          >
            <div
              onFocus={() => setActiveField("imageReference")}
              onBlur={() => setActiveField(null)}
            >
              <Form.Control
          ...
          >
            <div
              onFocus={() => setActiveField("imageCredentials")}
              onBlur={() => setActiveField(null)}
            >
              <Controller
                control={control}
          ...
          >
            <div
              onFocus={() => setActiveField("hostname")}
              onBlur={() => setActiveField(null)}
            >
              <Form.Control
          ...
          >
            <div
              onFocus={() => setActiveField("networkMode")}
              onBlur={() => setActiveField(null)}
            >
              <Form.Control
          ...
          >
            <div
              onFocus={() => setActiveField("networks")}
              onBlur={() => setActiveField(null)}
            >
              <Controller
                ...
                render={({
                  ...
                  const mappedValue: any[] = (value || []).map((v: any) => {
                    const id = v.id ?? "";
                    return (
          ...
          >
            <div
              onFocus={() => setActiveField("portBindings")}
              onBlur={() => setActiveField(null)}
            >
              <Form.Control
          ...
          >
            <div
              onFocus={() => setActiveField("restartPolicy")}
              onBlur={() => setActiveField(null)}
            >
              <Controller
                control={control}
          ...
          >
            <div
              onFocus={() => setActiveField("volumes")}
              onBlur={() => setActiveField(null)}
            >
              <div className="p-3 mb-3 bg-light border rounded">
                <Stack gap={3}>
          ...
          >
            <div
              onFocus={() => setActiveField("memoryReservation")}
              onBlur={() => setActiveField(null)}
            >
              <Form.Control
                type="number"
          ...
          >
            <div
              onFocus={() => setActiveField("memorySwap")}
              onBlur={() => setActiveField(null)}
            >
              <Form.Control
                type="number"
          ...
          >
            <div
              onFocus={() => setActiveField("memorySwappiness")}
              onBlur={() => setActiveField(null)}
            >
              <Form.Control
                type="number"
          ...
          >
            <div
              onFocus={() => setActiveField("cpuPeriod")}
              onBlur={() => setActiveField(null)}
            >
              <Form.Control
                type="number"
          ...
          >
            <div
              onFocus={() => setActiveField("cpuQuota")}
              onBlur={() => setActiveField(null)}
            >
              <Form.Control
                type="number"
          ...
          >
            <div
              onFocus={() => setActiveField("cpuRealtimePeriod")}
              onBlur={() => setActiveField(null)}
            >
              <Form.Control
                type="number"
          ...
          >
            <div
              onFocus={() => setActiveField("cpuRealtimeRuntime")}
              onBlur={() => setActiveField(null)}
            >
              <Form.Control
                type="number"
          ...
          >
            <div
              onFocus={() => setActiveField("privileged")}
              onBlur={() => setActiveField(null)}
            >
              <Form.Check
                type="checkbox"
          ...
          >
            <div
              onFocus={() => setActiveField("readOnlyRootfs")}
              onBlur={() => setActiveField(null)}
            >
              <Form.Check
                type="checkbox"
          ...
          >
            <div
              onFocus={() => setActiveField("storageOpt")}
              onBlur={() => setActiveField(null)}
            >
              <Controller
                control={control}
          ...
          >
            <div
              onFocus={() => setActiveField("capDrop")}
              onBlur={() => setActiveField(null)}
            >
              <Controller
          ...
          >
            <div
              onFocus={() => setActiveField("volumeDriver")}
              onBlur={() => setActiveField(null)}
            >
              <Form.Control
          ...
          >
            <div
              onFocus={() => setActiveField("deviceMappings")}
              onBlur={() => setActiveField(null)}
            >
              <div className="p-3 mb-3 bg-light border rounded">
