    ...
    <form>
      <Stack gap={3}>
        <FormRow
          ...
          label={
            <FormattedMessage id="forms.UpdateImageCredential.labelLabel" />
          }
        >
          <Form.Control
            {...register("label")}
        ...
        <FormRow
          ...
          label={
            <FormattedMessage id="forms.UpdateImageCredential.usernameLabel" />
          }
        >
          <Form.Control
            {...register("username")}
        ...
        >
          <Button variant="danger" onClick={onDelete}>
            <FormattedMessage id="forms.UpdateImageCredential.deleteButton" />
          </Button>
        </Stack>
      </Stack>
    </form>
