    ...
    <form onSubmit={handleSubmit(onSubmit)} autoComplete="off">
      ...
      <Stack gap={3}>
        <FormRow
          ...
          label={
            <FormattedMessage id="components.CreateImageCredentialForm.labelLabel" />
          }
        >
        ...
        <FormRow
          ...
          label={
            <FormattedMessage id="components.CreateImageCredentialForm.usernameLabel" />
          }
        >
          <Form.Control
            {...register("username")}
        ...
        <FormRow
          ...
          label={
            <FormattedMessage id="components.CreateImageCredentialForm.passwordLabel" />
          }
        >
          <Form.Control
            {...register("password")}
