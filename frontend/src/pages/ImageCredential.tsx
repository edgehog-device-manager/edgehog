...
> = ({
  ...
  const handleDeleteImageCredential = useCallback(() => {
    deleteImageCredential({
      ...
      onError() {
        setErrorFeedback(
          <FormattedMessage id="pages.ImageCredential.deletionErrorFeedback" />,
        );
        setShowDeleteModal(false);
      },
    });
      ...
      <Main>
        ...
        {showDeleteModal && (
          <DeleteModal
            ...
            title={
              <FormattedMessage id="pages.ImageCredential.deleteModal.title" />
            }
          >
            <p>
              <FormattedMessage
...
> = ({ imageCredentialQuery }) => {
  ...
  if (!imageCredentials) {
    return (
      <NotFound
        title={
          <FormattedMessage id="pages.ImageCredential.imageCredentialNotFound.title" />
        }
      >
        <Link route={imageCredentialsRoute}>
          <FormattedMessage id="pages.ImageCredential.imageCredentialNotFound.message" />
        </Link>
      </NotFound>
    );
  }
