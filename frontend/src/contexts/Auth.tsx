...
const hasRequiredValues = (session: Session): boolean =>
  Boolean(session.tenantSlug) && Boolean(session.authToken);
...
const AuthProvider = ({ children, fetchGraphQL }: AuthProviderProps) => {
  ...
  const logout = useCallback(() => {
    updateSession({ tenantSlug: session.tenantSlug, authToken: null });
