...
const statusMessages = defineMessages<BatterySlotStatus>({
  CHARGING: {
    id: "components.fleet.devices.battery-table.BatteryTable.status.Charging",
    defaultMessage: "Charging",
  },
  DISCHARGING: {
    id: "components.fleet.devices.battery-table.BatteryTable.status.Discharging",
    defaultMessage: "Discharging",
  },
  EITHER_IDLE_OR_CHARGING: {
    id: "components.fleet.devices.battery-table.BatteryTable.status.Either_idle_or_charging",
    defaultMessage: "Idle/Charging",
  },
  FAILURE: {
    id: "components.fleet.devices.battery-table.BatteryTable.status.Failure",
    defaultMessage: "Failure",
  },
  IDLE: {
    id: "components.fleet.devices.battery-table.BatteryTable.status.Idle",
    defaultMessage: "Idle",
  },
  REMOVED: {
    id: "components.fleet.devices.battery-table.BatteryTable.status.Removed",
    defaultMessage: "Removed",
  },
  UNKNOWN: {
    id: "components.fleet.devices.battery-table.BatteryTable.status.Unknown",
...
const columns = [
  columnHelper.accessor("slot", {
    header: () => (
      <FormattedMessage
        id="components.fleet.devices.battery-table.BatteryTable.slotTitle"
        defaultMessage="Slot"
      />
    ),
  }),
  columnHelper.accessor("status", {
    header: () => (
      <FormattedMessage
        id="components.fleet.devices.battery-table.BatteryTable.statusTitle"
  ...
  columnHelper.accessor("levelPercentage", {
    header: () => (
      <FormattedMessage
        id="components.fleet.devices.battery-table.BatteryTable.chargeLevelTitle"
  ...
  if (!batteryStatus || !batteryStatus.length) {
    return (
      <Result.EmptyList
        title={
          <FormattedMessage
            id="components.fleet.devices.battery-table.BatteryTable.noBattery.title"
            defaultMessage="No battery"
          />
        }
      >
        <FormattedMessage
          id="components.fleet.devices.battery-table.BatteryTable.noBattery.message"
