  ...
  const launchManualOTAUpdate = ({
    ...
    createOtaOperation({
      ...
      onError() {
        setErrorFeedback(
          <FormattedMessage
            id="components.fleet.devices.tabs.software-update-tab.SoftwareUpdateTab.otaUpdateCreationErrorFeedback"
  ...
  return (
    <Tab
      ...
      title={intl.formatMessage({
        id: "components.fleet.devices.tabs.software-update-tab.SoftwareUpdateTab.title",
    ...
    >
      <Card className="h-100 border-0 p-3 shadow-sm mb-3">
        <h5>
          <FormattedMessage
            id="components.fleet.devices.tabs.software-update-tab.SoftwareUpdateTab.manualOTAUpdate"
          ...
          <Stack direction="vertical" gap={3} className="mt-3">
            <div>
              ...
              >
                ...
                >
                  <FormattedMessage
                    id="components.fleet.devices.tabs.software-update-tab.SoftwareUpdateTab.modeFile"
                    defaultMessage="File"
                  />
                </ToggleButton>
                ...
                >
                  <FormattedMessage
                    id="components.fleet.devices.tabs.software-update-tab.SoftwareUpdateTab.modeCollection"
      ...
      <Card className="gap-2 border-0 shadow-sm flex-grow-1 p-4">
        <h5 className="mt-4">
          <FormattedMessage
            id="components.fleet.devices.tabs.software-update-tab.SoftwareUpdateTab.updatesHistory"
