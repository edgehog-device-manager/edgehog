  ...
  const handleSubmit = useCallback(
    async (values: ManualFileDeleteRequestFormValues) => {
      if (!isOnline) {
        setErrorFeedback(
          <FormattedMessage
            id="components.fleet.devices.tabs.files-delete-tab.FilesDeleteTab.deviceOffline"
      ...
      try {
        ...
        setErrorFeedback(
          error instanceof Error
            ? error.message
            : intl.formatMessage({
                id: "components.fleet.devices.tabs.files-delete-tab.FilesDeleteTab.unknownError",
  ...
  const content = (
    <>
      ...
      <Card className="gap-2 border-0 shadow-sm flex-grow-1 p-4">
        <h5>
          <FormattedMessage
            id="components.fleet.devices.tabs.files-delete-tab.FilesDeleteTab.requestHistory"
  ...
  return (
    <Tab
      ...
      title={intl.formatMessage({
        id: "components.fleet.devices.tabs.files-delete-tab.FilesDeleteTab.title",
    ...
    >
      <div className="mt-3">
        <h6>
          <FormattedMessage
            id="components.fleet.devices.tabs.files-delete-tab.FilesDeleteTab.deleteSource"
