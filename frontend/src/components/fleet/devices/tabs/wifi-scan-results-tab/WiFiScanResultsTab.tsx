...
import WiFiScanResultsTable from "@/components/fleet/devices/wifi-scan-results-table/WiFiScanResultsTable";
  ...
  return (
    <Tab
      ...
      title={intl.formatMessage({
        id: "components.fleet.devices.tabs.wifi-scan-results-tab.WiFiScanResultsTab.title",
