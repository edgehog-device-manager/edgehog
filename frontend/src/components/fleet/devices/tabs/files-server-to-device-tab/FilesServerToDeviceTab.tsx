  ...
  const handleFileUpload = useCallback(
    async (values: FileDownloadRequestFormValues) => {
      if (!isOnline) {
        setErrorFeedback(
          <FormattedMessage
            id="components.fleet.devices.tabs.files-server-to-device-tab.FilesServerToDeviceTab.deviceOfflineError"
      ...
      try {
        ...
        if (err instanceof APIValidationError) {
          ...
          setErrorFeedback(
            <FormattedMessage
              id="components.fleet.devices.tabs.files-server-to-device-tab.FilesServerToDeviceTab.uploadErrorFeedback"
    ...
    (values: ManualFileDownloadRequestFromRepositoryData) => {
      ...
      createFileDownloadRequest({
        ...
        onError: () => {
          ...
          setErrorFeedback(
            <FormattedMessage
              id="components.fleet.devices.tabs.files-server-to-device-tab.FilesServerToDeviceTab.creationErrorFeedback"
  ...
  const destinationTypeOptions = useMemo<DestinationTypeOption[]>(() => {
    ...
    if (capabilities.storage != null) {
      options.push({
        ...
        label: intl.formatMessage({
          id: "components.fleet.devices.tabs.files-server-to-device-tab.FilesServerToDeviceTab.destinationType.storage",
    ...
    if (capabilities.streaming != null) {
      options.push({
        value: "STREAMING",
        label: intl.formatMessage({
          id: "components.fleet.devices.tabs.files-server-to-device-tab.FilesServerToDeviceTab.destinationType.streaming",
    ...
    if (capabilities.filesystem != null) {
      options.push({
        value: "FILESYSTEM",
        label: intl.formatMessage({
          id: "components.fleet.devices.tabs.files-server-to-device-tab.FilesServerToDeviceTab.destinationType.filesystem",
  ...
  const content = (
    <>
            ...
            {embeddedMode == null && (
              <div>
                ...
                >
                  ...
                  >
                    <FormattedMessage
                      id="components.fleet.devices.tabs.files-server-to-device-tab.FilesServerToDeviceTab.modeFile"
                  ...
                  >
                    <FormattedMessage
                      id="components.fleet.devices.tabs.files-server-to-device-tab.FilesServerToDeviceTab.modeRepository"
      ...
      <Card className="gap-2 border-0 shadow-sm flex-grow-1 p-4">
        <h5>
          <FormattedMessage
            id="components.fleet.devices.tabs.files-server-to-device-tab.FilesServerToDeviceTab.requestHistory"
  ...
  return (
    <Tab
      ...
      title={intl.formatMessage({
        id: "components.fleet.devices.tabs.files-server-to-device-tab.FilesServerToDeviceTab.title",
    ...
    >
      <div className="mt-3">
        <h5>
          <FormattedMessage
            id="components.fleet.devices.tabs.files-server-to-device-tab.FilesServerToDeviceTab.uploadLocation"
