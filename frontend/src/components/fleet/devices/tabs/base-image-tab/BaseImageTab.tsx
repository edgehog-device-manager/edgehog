  ...
  return (
    <Tab
      ...
      title={intl.formatMessage({
        id: "components.fleet.devices.tabs.base-image-tab.BaseImageTab.title",
        ...
        <Stack gap={3}>
          {baseImage.name !== null && (
            <FormRow
              ...
              label={
                <FormattedMessage
                  id="components.fleet.devices.tabs.base-image-tab.BaseImageTab.name"
                  defaultMessage="Name"
                />
              }
            >
          ...
          {baseImage.version !== null && (
            <FormRow
              ...
              label={
                <FormattedMessage
                  id="components.fleet.devices.tabs.base-image-tab.BaseImageTab.version"
          ...
          {baseImage.buildId !== null && (
            <FormRow
              ...
              label={
                <FormattedMessage
                  id="components.fleet.devices.tabs.base-image-tab.BaseImageTab.buildId"
          ...
          {baseImage.fingerprint !== null && (
            <FormRow
              ...
              label={
                <FormattedMessage
                  id="components.fleet.devices.tabs.base-image-tab.BaseImageTab.fingerprint"
