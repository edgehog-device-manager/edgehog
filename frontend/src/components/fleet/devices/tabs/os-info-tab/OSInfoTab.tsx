  ...
  return (
    <Tab
      ...
      title={intl.formatMessage({
        id: "components.fleet.devices.tabs.os-info-tab.OSInfoTab.title",
        ...
        <Stack gap={3}>
          {osInfo.name !== null && (
            <FormRow
              ...
              label={
                <FormattedMessage
                  id="components.fleet.devices.tabs.os-info-tab.OSInfoTab.name"
          ...
          {osInfo.version !== null && (
            <FormRow
              ...
              label={
                <FormattedMessage
                  id="components.fleet.devices.tabs.os-info-tab.OSInfoTab.version"
