  ...
  return (
    <Tab
      ...
      title={intl.formatMessage({
        id: "components.fleet.devices.tabs.runtime-info-tab.RuntimeInfoTab.title",
        ...
        <Stack gap={3}>
          {runtimeInfo.name !== null && (
            <FormRow
              ...
              label={
                <FormattedMessage
                  id="components.fleet.devices.tabs.runtime-info-tab.RuntimeInfoTab.name"
                  defaultMessage="Name"
                />
              }
            >
          ...
          {runtimeInfo.version !== null && (
            <FormRow
              ...
              label={
                <FormattedMessage
                  id="components.fleet.devices.tabs.runtime-info-tab.RuntimeInfoTab.version"
          ...
          {runtimeInfo.environment !== null && (
            <FormRow
              ...
              label={
                <FormattedMessage
                  id="components.fleet.devices.tabs.runtime-info-tab.RuntimeInfoTab.environment"
          ...
          {runtimeInfo.url !== null && (
            <FormRow
              ...
              label={
                <FormattedMessage
                  id="components.fleet.devices.tabs.runtime-info-tab.RuntimeInfoTab.url"
                  defaultMessage="URL"
                />
              }
            >
