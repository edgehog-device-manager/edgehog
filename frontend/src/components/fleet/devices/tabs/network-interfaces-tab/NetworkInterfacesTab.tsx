...
import NetworkInterfacesTable from "@/components/fleet/devices/network-interfaces-table/NetworkInterfacesTable";
  ...
  return (
    <Tab
      ...
      title={intl.formatMessage({
        id: "components.fleet.devices.tabs.network-interfaces-tab.NetworkInterfacesTab.title",
