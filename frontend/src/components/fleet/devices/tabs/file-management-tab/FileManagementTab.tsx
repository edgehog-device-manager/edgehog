...
import FilesDeleteTab from "@/components/fleet/devices/tabs/files-delete-tab/FilesDeleteTab";
import FilesDownloadTab from "@/components/fleet/devices/tabs/files-device-to-server-tab/FilesDeviceToServerTab";
import FilesServerToDeviceTab from "@/components/fleet/devices/tabs/files-server-to-device-tab/FilesServerToDeviceTab";
  ...
  const modeOptions = useMemo<Array<FileManagementModeOption>>(() => {
      ...
      options.push(
        {
          ...
          label: intl.formatMessage({
            id: "components.fleet.devices.tabs.file-management-tab.FileManagementTab.toDeviceDirect",
        ...
        },
        {
          ...
          label: intl.formatMessage({
            id: "components.fleet.devices.tabs.file-management-tab.FileManagementTab.toDeviceRepository",
    ...
    if (supportsDeviceToServer) {
      options.push({
        ...
        label: intl.formatMessage({
          id: "components.fleet.devices.tabs.file-management-tab.FileManagementTab.uploadFromDevice",
    ...
    if (supportsDeleteFromDevice) {
      options.push({
        ...
        label: intl.formatMessage({
          id: "components.fleet.devices.tabs.file-management-tab.FileManagementTab.deleteFromDevice",
      ...
      {modeOptions.length > 1 && (
        <Card className="h-100 border-0 p-3 shadow-sm mb-3">
          <Form.Group controlId="file-management-mode" className="mb-0">
            <h5>
              <FormattedMessage
                id="components.fleet.devices.tabs.file-management-tab.FileManagementTab.fileManagementLabel"
