  ...
  return (
    <Tab
      ...
      title={intl.formatMessage({
        id: "components.fleet.devices.tabs.system-status-tab.SystemStatusTab.title",
    ...
    >
      <Card className="gap-2 border-0 shadow-sm flex-grow-1 p-4">
        <p className="text-muted">
          <FormattedMessage
            id="components.fleet.devices.tabs.system-status-tab.SystemStatusTab.lastUpdateAt"
        ...
        <Stack gap={3}>
          {systemStatus.memoryFreeBytes != null && (
            <FormRow
              ...
              label={
                <FormattedMessage
                  id="components.fleet.devices.tabs.system-status-tab.SystemStatusTab.memoryFreeBytes"
          ...
          {systemStatus.taskCount != null && (
            <FormRow
              ...
              label={
                <FormattedMessage
                  id="components.fleet.devices.tabs.system-status-tab.SystemStatusTab.taskCount"
          ...
          {systemStatus.uptimeMilliseconds != null && (
            <FormRow
              ...
              label={
                <FormattedMessage
                  id="components.fleet.devices.tabs.system-status-tab.SystemStatusTab.uptimeMilliseconds"
