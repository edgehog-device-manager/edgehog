...
const technologyMessages = defineMessages<NetworkInterfaceTechnology>({
  ETHERNET: {
    id: "components.fleet.devices.network-interfaces-table.NetworkInterfacesTable.technology.Ethernet",
    defaultMessage: "Ethernet",
  },
  WIFI: {
    id: "components.fleet.devices.network-interfaces-table.NetworkInterfacesTable.technology.WiFi",
    defaultMessage: "WiFi",
  },
  CELLULAR: {
    id: "components.fleet.devices.network-interfaces-table.NetworkInterfacesTable.technology.Cellular",
    defaultMessage: "Cellular",
  },
  BLUETOOTH: {
    id: "components.fleet.devices.network-interfaces-table.NetworkInterfacesTable.technology.Bluetooth",
...
const columns = [
  columnHelper.accessor("name", {
    header: () => (
      <FormattedMessage
        id="components.fleet.devices.network-interfaces-table.NetworkInterfacesTable.nameTitle"
        defaultMessage="Name"
      />
    ),
  }),
  columnHelper.accessor("technology", {
    header: () => (
      <FormattedMessage
        id="components.fleet.devices.network-interfaces-table.NetworkInterfacesTable.technologyTitle"
  ...
  columnHelper.accessor("macAddress", {
    header: () => (
      <FormattedMessage
        id="components.fleet.devices.network-interfaces-table.NetworkInterfacesTable.macAddressTitle"
  ...
  if (!networkInterfaces || !networkInterfaces.length) {
    return (
      <Result.EmptyList
        title={
          <FormattedMessage
            id="components.fleet.devices.network-interfaces-table.NetworkInterfacesTable.noResults.title"
            defaultMessage="No results"
          />
        }
      >
        <FormattedMessage
          id="components.fleet.devices.network-interfaces-table.NetworkInterfacesTable.noResults.message"
