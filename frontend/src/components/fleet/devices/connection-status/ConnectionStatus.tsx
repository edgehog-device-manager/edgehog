...
const ConnectionStatus = ({ connected, icon = true }: Props) => {
  ...
  const label = connected
    ? intl.formatMessage({
        id: "components.fleet.devices.connection-status.ConnectionStatus.statusConnected",
        defaultMessage: "Online",
      })
    : intl.formatMessage({
        id: "components.fleet.devices.connection-status.ConnectionStatus.statusDisconnected",
