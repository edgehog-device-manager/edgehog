...
const columns = [
  ...
  columnHelper.accessor("totalBytes", {
    header: () => (
      <FormattedMessage
        id="components.fleet.devices.storage-table.StorageTable.totalSpaceTitle"
  ...
  columnHelper.accessor("freeBytes", {
    header: () => (
      <FormattedMessage
        id="components.fleet.devices.storage-table.StorageTable.freeSpaceTitle"
  ...
  if (!storageUsage || !storageUsage.length) {
    return (
      <Result.EmptyList
        title={
          <FormattedMessage
            id="components.fleet.devices.storage-table.StorageTable.noStorage.title"
            defaultMessage="No storage"
          />
        }
      >
        <FormattedMessage
          id="components.fleet.devices.storage-table.StorageTable.noStorage.message"
