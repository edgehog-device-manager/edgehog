  ...
  return (
    <>
      <Container fluid>
        {data.length > 0 && (
          <Row className="mb-3">
            <Col>
              <FormattedMessage
                id="components.fleet.device-groups.device-mappings-form-input.DeviceMappingsFormInput.pathInContainerLabel"
                defaultMessage="Path In Container"
              />
            </Col>
            <Col>
              <FormattedMessage
                id="components.fleet.device-groups.device-mappings-form-input.DeviceMappingsFormInput.pathOnHostLabel"
                defaultMessage="Path On Host"
              />
            </Col>
            <Col>
              <FormattedMessage
                id="components.fleet.device-groups.device-mappings-form-input.DeviceMappingsFormInput.cgroupPermissionsLabel"
      ...
      {!readOnly && (
        ...
        >
          <FormattedMessage
            id="components.fleet.device-groups.device-mappings-form-input.DeviceMappingsFormInput.addDeviceMappingButton"
