...
const columns = [
  columnHelper.accessor("online", {
    header: () => (
      <FormattedMessage
        id="components.fleet.device-groups.devices-groups-table.DevicesGroupsTable.statusTitle"
  ...
  columnHelper.accessor("name", {
    header: () => (
      <FormattedMessage
        id="components.fleet.device-groups.devices-groups-table.DevicesGroupsTable.nameTitle"
  ...
  columnHelper.accessor("deviceId", {
    header: () => (
      <FormattedMessage
        id="components.fleet.device-groups.devices-groups-table.DevicesGroupsTable.deviceIdTitle"
  ...
  columnHelper.accessor((device) => device.systemModel?.name, {
    ...
    header: () => (
      <FormattedMessage
        id="components.fleet.device-groups.devices-groups-table.DevicesGroupsTable.systemModel"
  ...
  columnHelper.accessor((device) => device.systemModel?.hardwareType?.name, {
    ...
    header: () => (
      <FormattedMessage
        id="components.fleet.device-groups.devices-groups-table.DevicesGroupsTable.hardwareType"
  ...
  columnHelper.accessor(
    ...
    },
    {
      ...
      header: () => (
        <FormattedMessage
          id="components.fleet.device-groups.devices-groups-table.DevicesGroupsTable.lastSeenTitle"
  ...
  columnHelper.accessor("tags", {
    ...
    header: () => (
      <FormattedMessage
        id="components.fleet.device-groups.devices-groups-table.DevicesGroupsTable.tagsTitle"
        defaultMessage="Tags"
