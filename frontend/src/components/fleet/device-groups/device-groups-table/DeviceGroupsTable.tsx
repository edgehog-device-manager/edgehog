...
const columns = [
  columnHelper.accessor("name", {
    header: () => (
      <FormattedMessage
        id="components.fleet.device-groups.device-groups-table.DeviceGroupsTable.nameTitle"
  ...
  columnHelper.accessor("handle", {
    header: () => (
      <FormattedMessage
        id="components.fleet.device-groups.device-groups-table.DeviceGroupsTable.handleTitle"
  ...
  columnHelper.accessor("selector", {
    header: () => (
      <FormattedMessage
        id="components.fleet.device-groups.device-groups-table.DeviceGroupsTable.selectorTitle"
...
const DeviceGroupsTable = ({
  ...
  const deviceGroups = useMemo<TableRecord[]>(() => {
    return compact(deviceGroupsFragment?.edges?.map((e) => e?.node)) ?? [];
