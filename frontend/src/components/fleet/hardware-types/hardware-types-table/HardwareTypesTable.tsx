...
const columns = [
  columnHelper.accessor("name", {
    header: () => (
      <FormattedMessage
        id="components.fleet.hardware-types.hardware-types-table.HardwareTypesTable.nameTitle"
  ...
  columnHelper.accessor("handle", {
    header: () => (
      <FormattedMessage
        id="components.fleet.hardware-types.hardware-types-table.HardwareTypesTable.handleTitle"
  ...
  columnHelper.accessor("partNumbers", {
    ...
    header: () => (
      <FormattedMessage
        id="components.fleet.hardware-types.hardware-types-table.HardwareTypesTable.partNumbersTitle"
