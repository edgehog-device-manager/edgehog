...
} from "@/components/ota/update-campaigns/update-targets-table/UpdateTargetsTable";
...
const columns = [
  columnHelper.accessor("status", {
    header: () => (
      <FormattedMessage
        id="components.ota.operation-table.OperationTable.operationStatus"
  ...
  columnHelper.accessor("statusProgress", {
    header: () => (
      <FormattedMessage
        id="components.ota.operation-table.OperationTable.operationStatusProgressTitle"
  ...
  columnHelper.accessor("statusCode", {
    header: () => (
      <FormattedMessage
        id="components.ota.operation-table.OperationTable.operationsStatusCodeTitle"
  ...
  columnHelper.accessor("campaignTarget.campaign.name", {
    header: () => (
      <FormattedMessage
        id="components.ota.operation-table.OperationTable.updateCampaignNameTitle"
  ...
  columnHelper.accessor("baseImageUrl", {
    header: () => (
      <FormattedMessage
        id="components.ota.operation-table.OperationTable.baseImage"
  ...
  columnHelper.accessor("createdAt", {
    header: () => (
      <FormattedMessage
        id="components.ota.operation-table.OperationTable.startedAt"
  ...
  columnHelper.accessor("updatedAt", {
    header: () => (
      <FormattedMessage
        id="components.ota.operation-table.OperationTable.updatedAt"
...
const OperationTable = ({
  ...
  if (!otaOperations) {
    return (
      <div>
        <FormattedMessage
          id="components.ota.operation-table.OperationTable.noPreviousUpdates"
