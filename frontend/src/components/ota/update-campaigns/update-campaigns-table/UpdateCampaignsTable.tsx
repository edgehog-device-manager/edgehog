...
const columns = [
  columnHelper.accessor("name", {
    header: () => (
      <FormattedMessage
        id="components.ota.update-campaigns.update-campaigns-table.UpdateCampaignsTable.nameTitle"
  ...
  columnHelper.accessor("status", {
    header: () => (
      <FormattedMessage
        id="components.ota.update-campaigns.update-campaigns-table.UpdateCampaignsTable.statusTitle"
  ...
  columnHelper.accessor("outcome", {
    header: () => (
      <FormattedMessage
        id="components.ota.update-campaigns.update-campaigns-table.UpdateCampaignsTable.outcomeTitle"
  ...
  columnHelper.accessor("channel.name", {
    header: () => (
      <FormattedMessage
        id="components.ota.update-campaigns.update-campaigns-table.UpdateCampaignsTable.channelNameTitle"
  ...
  columnHelper.accessor(
    "campaignMechanism.baseImage.baseImageCollection.name",
    {
      header: () => (
        <FormattedMessage
          id="components.ota.update-campaigns.update-campaigns-table.UpdateCampaignsTable.baseImageCollectionNameTitle"
  ...
  columnHelper.accessor("campaignMechanism.baseImage.name", {
    header: () => (
      <FormattedMessage
        id="components.ota.update-campaigns.update-campaigns-table.UpdateCampaignsTable.baseImageTitle"
