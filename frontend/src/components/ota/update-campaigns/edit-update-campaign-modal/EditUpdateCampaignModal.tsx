...
const EditUpdateCampaignModal = ({
    ...
    (data: EditUpdateCampaignFormData) => {
      updateCampaign({
        ...
        onError() {
          setErrorFeedback(
            <FormattedMessage
              id="components.ota.update-campaigns.edit-update-campaign-modal.EditUpdateCampaignModal.error"
  ...
  return (
    <EditModal
      title={
        <FormattedMessage
          id="components.ota.update-campaigns.edit-update-campaign-modal.EditUpdateCampaignModal.title"
    ...
    >
      <Stack gap={3}>
        <FormRow
          ...
          label={
            <FormattedMessage
              id="components.ota.update-campaigns.edit-update-campaign-modal.EditUpdateCampaignModal.nameLabel"
              defaultMessage="Name"
            />
          }
        >
        ...
        <FormRow
          ...
          label={
            <FormattedMessage
              id="components.ota.update-campaigns.edit-update-campaign-modal.EditUpdateCampaignModal.baseImageCollectionLabel"
            ...
            render={({
              ...
              <Select
                ...
                placeholder={intl.formatMessage({
                  id: "components.ota.update-campaigns.edit-update-campaign-modal.EditUpdateCampaignModal.baseImageCollectionOption",
        ...
        <FormRow
          ...
          label={
            <FormattedMessage
              id="components.ota.update-campaigns.edit-update-campaign-modal.EditUpdateCampaignModal.baseImageLabel"
        ...
        >
          {selectedBaseImageCollection?.id ? (
            ...
            <div className="d-flex align-content-center fst-italic text-muted">
              <FormattedMessage
                id="components.ota.update-campaigns.edit-update-campaign-modal.EditUpdateCampaignModal.selectBaseImageCollection"
        ...
        <FormRow
          ...
          label={
            <FormattedMessage
              id="components.ota.update-campaigns.edit-update-campaign-modal.EditUpdateCampaignModal.maxInProgressOperationsLabel"
        ...
        <FormRow
          ...
          label={
            <FormattedMessage
              id="components.ota.update-campaigns.edit-update-campaign-modal.EditUpdateCampaignModal.maxFailurePercentageLabel"
        ...
        <FormRow
          ...
          label={
            <FormattedMessage
              id="components.ota.update-campaigns.edit-update-campaign-modal.EditUpdateCampaignModal.requestTimeoutSecondsLabel"
        ...
        <FormRow
          ...
          label={
            <FormattedMessage
              id="components.ota.update-campaigns.edit-update-campaign-modal.EditUpdateCampaignModal.otaRequestRetriesLabel"
        ...
        <FormRow
          ...
          label={
            <FormattedMessage
              id="components.ota.update-campaigns.edit-update-campaign-modal.EditUpdateCampaignModal.forceDowngradeLabel"
        ...
        <FormRow
          ...
          label={
            <FormattedMessage
              id="components.ota.update-campaigns.edit-update-campaign-modal.EditUpdateCampaignModal.scheduledAtTimestampLabel"
