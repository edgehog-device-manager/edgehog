...
import type { ColumnId } from "@/components/ota/update-campaigns/update-targets-table/UpdateTargetsTable";
import UpdateTargetsTable, {
  columnIds,
...
const UpdateTargetsTabs = ({ campaignRef }: Props) => {
  ...
  return (
    <div>
      <h3>
        <FormattedMessage
          id="components.ota.update-campaigns.update-targets-tabs.UpdateTargetsTabs.updateTargetsLabel"
