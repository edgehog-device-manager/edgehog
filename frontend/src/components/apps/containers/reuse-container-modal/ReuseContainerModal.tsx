  ...
  return (
    <ConfirmModal
      title={intl.formatMessage({
        id: "components.apps.containers.reuse-container-modal.ReuseContainerModal.reuseResourcesTitle",
        defaultMessage: "Reuse Resources",
      })}
      confirmLabel={
        <FormattedMessage
          id="components.apps.containers.reuse-container-modal.ReuseContainerModal.confirmButton"
    ...
    >
      <p>
        <FormattedMessage
          id="components.apps.containers.reuse-container-modal.ReuseContainerModal.confirmPrompt"
      ...
      <div className="mb-2 d-flex flex-column gap-2">
        <FormRow
          ...
          label={intl.formatMessage({
            id: "components.apps.containers.reuse-container-modal.ReuseContainerModal.selectContainer",
