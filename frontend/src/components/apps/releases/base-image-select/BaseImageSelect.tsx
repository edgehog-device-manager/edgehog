...
const noBaseImageOptionsMessage = (
  ...
  inputValue
    ? intl.formatMessage(
        {
          id: "components.apps.releases.base-image-select.BaseImageSelect.noBaseImagesFoundMatching",
          defaultMessage: 'No base images found matching "{inputValue}"',
        },
        { inputValue },
      )
    : intl.formatMessage({
        id: "components.apps.releases.base-image-select.BaseImageSelect.noBaseImagesAvailable",
  ...
  return (
    <Select
      ...
      placeholder={intl.formatMessage({
        id: "components.apps.releases.base-image-select.BaseImageSelect.baseImageOption",
...
const ErrorFallback = ({ resetErrorBoundary }: FallbackProps) => (
  <Stack direction="horizontal">
    <span>
      <FormattedMessage
        id="components.apps.releases.base-image-select.BaseImageSelect.ErrorFallback.message"
        defaultMessage="Failed to load Base Images list."
      />
    </span>
    <Button variant="link" onClick={resetErrorBoundary}>
      <FormattedMessage
        id="components.apps.releases.base-image-select.BaseImageSelect.ErrorFallback.reloadButton"
