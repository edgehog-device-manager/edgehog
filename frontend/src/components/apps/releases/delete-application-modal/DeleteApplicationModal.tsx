...
const DeleteApplicationModal = <A extends Application>({
  ...
  const handleDeleteApplication = useCallback(() => {
    deleteApplication({
      ...
      onError() {
        setErrorFeedback(
          <FormattedMessage
            id="components.apps.releases.delete-application-modal.DeleteApplicationModal.deletionErrorFeedback"
  ...
  return (
    <DeleteModal
      ...
      title={
        <FormattedMessage
          id="components.apps.releases.delete-application-modal.DeleteApplicationModal.deleteModal.title"
    ...
    >
      <p>
        <FormattedMessage
          id="components.apps.releases.delete-application-modal.DeleteApplicationModal.deleteModal.description"
