...
const DeployedApplicationsTable = ({
  ...
  if (!groupedDeployments.length) {
    return (
      <FormattedMessage
        id="components.apps.releases.deployed-applications-table.DeployedApplicationsTable.noDeployedApplications"
                      ...
                      <td className="text-end align-middle">
                        <div className="d-flex justify-content-end align-items-center gap-2">
                          {rel.id === latest.id && (
                            <Badge bg="primary">
                              <FormattedMessage
                                id="components.apps.releases.deployed-applications-table.DeployedApplicationsTable.latest"
