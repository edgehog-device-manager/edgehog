...
const ApplicationDevicesTable = ({
  ...
  const columns = [
    columnHelper.accessor("device.online", {
      header: () => (
        <FormattedMessage
          id="components.apps.releases.application-devices-table.ApplicationDevicesTable.statusTitle"
    ...
    columnHelper.accessor("device.name", {
      header: () => (
        <FormattedMessage
          id="components.apps.releases.application-devices-table.ApplicationDevicesTable.nameTitle"
    ...
    columnHelper.accessor("release.version", {
      header: () => (
        <FormattedMessage
          id="components.apps.releases.application-devices-table.ApplicationDevicesTable.releaseVersionTitle"
    ...
    columnHelper.accessor("state", {
      header: () => (
        <FormattedMessage
          id="components.apps.releases.application-devices-table.ApplicationDevicesTable.applicationStateTitle"
