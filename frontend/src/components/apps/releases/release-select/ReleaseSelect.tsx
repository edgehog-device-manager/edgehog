...
const noReleaseOptionsMessage = (
  ...
  inputValue
    ? intl.formatMessage(
        {
          id: "components.apps.releases.release-select.ReleaseSelect.noReleasesFoundMatching",
          defaultMessage: 'No releases found matching "{inputValue}"',
        },
        { inputValue },
      )
    : intl.formatMessage({
        id: "components.apps.releases.release-select.ReleaseSelect.noReleasesAvailable",
  ...
  return (
    <Select
      ...
      placeholder={intl.formatMessage({
        id: "components.apps.releases.release-select.ReleaseSelect.releaseOption",
...
const ErrorFallback = ({ resetErrorBoundary }: FallbackProps) => (
  <Stack direction="horizontal">
    <span>
      <FormattedMessage
        id="components.apps.releases.release-select.ReleaseSelect.ErrorFallback.message"
        defaultMessage="Failed to load Releases list."
      />
    </span>
    <Button variant="link" onClick={resetErrorBoundary}>
      <FormattedMessage
        id="components.apps.releases.release-select.ReleaseSelect.ErrorFallback.reloadButton"
