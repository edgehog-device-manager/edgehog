...
const ReleaseSystemModelsTable = ({
  ...
  const columns = [
    columnHelper.accessor("name", {
      header: () => (
        <FormattedMessage
          id="components.apps.releases.release-system-models-table.ReleaseSystemModelsTable.nameTitle"
  ...
  return (
    <div>
      {systemModels.length ? (
        ...
        <p>
          <FormattedMessage
            id="components.apps.releases.release-system-models-table.ReleaseSystemModelsTable.noSystemModels"
