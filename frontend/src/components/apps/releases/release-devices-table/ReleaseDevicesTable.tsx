...
const ReleaseDevicesTable = ({
  ...
  const columns = [
    columnHelper.accessor("device.online", {
      header: () => (
        <FormattedMessage
          id="components.apps.releases.release-devices-table.ReleaseDevicesTable.statusTitle"
    ...
    columnHelper.accessor("device.name", {
      header: () => (
        <FormattedMessage
          id="components.apps.releases.release-devices-table.ReleaseDevicesTable.deviceNameTitle"
    ...
    columnHelper.accessor("state", {
      header: () => (
        <FormattedMessage
          id="components.apps.releases.release-devices-table.ReleaseDevicesTable.applicationStateTitle"
    ...
    <div>
      {deployments.length ? (
        <InfiniteTable
          ...
          columnVisibilityKey="releaseDevices-table"
        />
      ) : (
        <p>
          <FormattedMessage
            id="components.apps.releases.release-devices-table.ReleaseDevicesTable.noDevices"
