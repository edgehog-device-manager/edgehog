...
const columns = [
  columnHelper.accessor("name", {
    header: () => (
      <FormattedMessage
        id="components.apps.releases.base-image-collections-table.BaseImageCollectionsTable.nameTitle"
  ...
  columnHelper.accessor("handle", {
    header: () => (
      <FormattedMessage
        id="components.apps.releases.base-image-collections-table.BaseImageCollectionsTable.handleTitle"
  ...
  columnHelper.accessor((row) => row.systemModel?.name, {
    ...
    header: () => (
      <FormattedMessage
        id="components.apps.releases.base-image-collections-table.BaseImageCollectionsTable.systemModelTitle"
...
const BaseImageCollectionsTable = ({
  ...
  const baseImageCollections = useMemo<TableRecord[]>(() => {
    return (
      compact(baseImageCollectionsFragment?.edges?.map((e) => e?.node)) ?? []
    );
