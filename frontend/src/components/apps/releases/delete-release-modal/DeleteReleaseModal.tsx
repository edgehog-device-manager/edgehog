...
const DeleteReleaseModal = <R extends Release>({
  ...
  const handleDeleteRelease = useCallback(() => {
    deleteRelease({
      ...
      onError() {
        setErrorFeedback(
          <FormattedMessage
            id="components.apps.releases.delete-release-modal.DeleteReleaseModal.deletionErrorFeedback"
  ...
  return (
    <DeleteModal
      ...
      title={
        <FormattedMessage
          id="components.apps.releases.delete-release-modal.DeleteReleaseModal.title"
    ...
    >
      <p>
        <FormattedMessage
          id="components.apps.releases.delete-release-modal.DeleteReleaseModal.description"
