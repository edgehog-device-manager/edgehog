...
import type { ColumnId } from "@/components/apps/deployments/deployment-targets-table/DeploymentTargetsTable";
import DeploymentTargetsTable, {
  columnIds,
} from "@/components/apps/deployments/deployment-targets-table/DeploymentTargetsTable";
...
const DeploymentTargetsTabs = ({ campaignRef }: Props) => {
  ...
  return (
    <div>
      <h3>
        <FormattedMessage
          id="components.apps.deployments.deployment-targets-tabs.DeploymentTargetsTabs.deploymentTargetsLabel"
