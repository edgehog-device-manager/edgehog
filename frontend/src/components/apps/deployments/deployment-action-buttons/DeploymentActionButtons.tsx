...
import "@/components/apps/deployments/deployment-action-buttons/DeploymentActionButtons.scss";
import type { DeploymentState } from "@/components/apps/deployments/deployment-state/DeploymentState";
      ...
      return (
        <Button
          ...
          title={intl.formatMessage({
            id: "components.apps.deployments.deployment-action-buttons.DeploymentActionButtons.sendButtonTitle",
    ...
    if (state === "STOPPED" || state === "ERROR") {
      return (
        <Button
          ...
          className="btn p-0 border-0 bg-transparent icon-click"
          title={intl.formatMessage({
            id: "components.apps.deployments.deployment-action-buttons.DeploymentActionButtons.startButtonTitle",
    ...
    if (state === "STARTED") {
      return (
        <Button
          ...
          className="btn p-0 border-0 bg-transparent icon-click"
          title={intl.formatMessage({
            id: "components.apps.deployments.deployment-action-buttons.DeploymentActionButtons.stopButtonTitle",
  ...
  return (
    <div className="d-flex align-items-center gap-2">
      ...
      <Button
        ...
        className="btn p-0 border-0 bg-transparent icon-click"
        title={intl.formatMessage({
          id: "components.apps.deployments.deployment-action-buttons.DeploymentActionButtons.upgradeButtonTitle",
      ...
      <Button
        ...
        className="btn p-0 border-0 bg-transparent icon-click"
        title={intl.formatMessage({
          id: "components.apps.deployments.deployment-action-buttons.DeploymentActionButtons.deleteButtonTitle",
