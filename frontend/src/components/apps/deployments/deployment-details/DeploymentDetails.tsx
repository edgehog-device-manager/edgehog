...
const ContainerDeploymentItem = ({
  ...
  const treeData: TreeNode[] = useMemo(() => {
    const unnamed = intl.formatMessage({
      id: "components.apps.deployments.deployment-details.DeploymentDetails.unnamed",
      defaultMessage: "Unnamed",
    });
    const empty = intl.formatMessage({
      id: "components.apps.deployments.deployment-details.DeploymentDetails.none",
      defaultMessage: "None",
    });
    ...
    const networkSubTree = buildSubTree(
      ...
      (n) => n.network?.label,
      {
        title: intl.formatMessage({
          id: "components.apps.deployments.deployment-details.DeploymentDetails.networks",
    ...
    const volumeSubTree = buildSubTree(
      ...
      {
        title: intl.formatMessage({
          id: "components.apps.deployments.deployment-details.DeploymentDetails.volumes",
    ...
    const deviceMappingsSubTree = buildSubTree(
      ...
      {
        title: intl.formatMessage({
          id: "components.apps.deployments.deployment-details.DeploymentDetails.deviceMappings",
    ...
    const fileBindsSubTree = buildSubTree(
      ...
      (fb) =>
        `${fb.fileMount?.mountpoint ?? unnamed} → ${
    ...
    const imageTreeNode: TreeNode = {
      ...
      name:
        ...
        intl.formatMessage({
          id: "components.apps.deployments.deployment-details.DeploymentDetails.unnamedImage",
    ...
    return [
      {
        ...
        name: intl.formatMessage(
          {
            id: "components.apps.deployments.deployment-details.DeploymentDetails.containerWithIndex",
    ...
    <div className="d-flex flex-column h-100">
          ...
          <Row className="d-flex align-items-center justify-content-between flex-wrap">
            ...
            >
              ...
              <Link route={Route.release} params={{ applicationId, releaseId }}>
                <FormattedMessage
                  id="components.apps.deployments.deployment-details.DeploymentDetails.releaseVersion"
      ...
      {showDeleteModal && (
        <DeleteModal
          ...
          title={
            <FormattedMessage
              id="components.apps.deployments.deployment-details.DeploymentDetails.deleteModal.title"
        ...
        >
          <p>
            <FormattedMessage
              id="components.apps.deployments.deployment-details.DeploymentDetails.deleteModal.description"
              defaultMessage="This action cannot be undone. This will permanently delete the deployment."
            />
          </p>
          <p className="text-muted small">
            <FormattedMessage
              id="components.apps.deployments.deployment-details.DeploymentDetails.deleteModal.note"
          ...
          <FullHeightCard md={4} xs={12} className="h-100">
            <Card.Body className="d-flex flex-column overflow-auto me-3">
              {containerNodes.length === 0 ? (
                <div className="p-2">
                  <FormattedMessage
                    id="components.apps.deployments.deployment-details.DeploymentDetails.noContainers"
