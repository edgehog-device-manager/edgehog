...
const columns = [
  columnHelper.accessor("name", {
    header: () => (
      <FormattedMessage
        id="components.apps.deployments.deployment-campaigns-table.DeploymentCampaignsTable.nameTitle"
  ...
  columnHelper.accessor("campaignMechanism.__typename", {
    header: () => (
      <FormattedMessage
        id="components.apps.deployments.deployment-campaigns-table.DeploymentCampaignsTable.operationTypeTitle"
  ...
  columnHelper.accessor("status", {
    header: () => (
      <FormattedMessage
        id="components.apps.deployments.deployment-campaigns-table.DeploymentCampaignsTable.statusTitle"
  ...
  columnHelper.accessor("outcome", {
    header: () => (
      <FormattedMessage
        id="components.apps.deployments.deployment-campaigns-table.DeploymentCampaignsTable.outcomeTitle"
  ...
  columnHelper.accessor("channel.name", {
    header: () => (
      <FormattedMessage
        id="components.apps.deployments.deployment-campaigns-table.DeploymentCampaignsTable.deploymentChannelNameTitle"
  ...
  columnHelper.accessor("campaignMechanism.release.application.name", {
    header: () => (
      <FormattedMessage
        id="components.apps.deployments.deployment-campaigns-table.DeploymentCampaignsTable.applicationNameTitle"
  ...
  columnHelper.accessor("campaignMechanism.release.version", {
    header: () => (
      <FormattedMessage
        id="components.apps.deployments.deployment-campaigns-table.DeploymentCampaignsTable.releaseVersionTitle"
