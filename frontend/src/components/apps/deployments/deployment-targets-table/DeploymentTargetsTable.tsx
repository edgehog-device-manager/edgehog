...
import DeploymentReadiness from "@/components/apps/deployments/deployment-readiness/DeploymentReadiness";
import DeploymentStateComponent from "@/components/apps/deployments/deployment-state/DeploymentState";
...
const columns = [
  columnHelper.accessor("device.name", {
    ...
    header: () => (
      <FormattedMessage
        id="components.apps.deployments.deployment-targets-table.DeploymentTargetsTable.deviceNameTitle"
  ...
  columnHelper.accessor(
    (campaignTarget) => campaignTarget.deployment?.state ?? null,
    {
      ...
      header: () => (
        <FormattedMessage
          id="components.apps.deployments.deployment-targets-table.DeploymentTargetsTable.stateTitle"
  ...
  columnHelper.accessor(
    (campaignTarget) => campaignTarget.deployment?.isReady ?? null,
    {
      ...
      header: () => (
        <FormattedMessage
          id="components.apps.deployments.deployment-targets-table.DeploymentTargetsTable.readinessTitle"
  ...
  columnHelper.accessor(
      ...
      campaignTarget.deployment?.events?.edges?.[0]?.node ?? null,
    {
      ...
      header: () => (
        <FormattedMessage
          id="components.apps.deployments.deployment-targets-table.DeploymentTargetsTable.lastErrorMessageTitle"
  ...
  columnHelper.accessor("retryCount", {
    header: () => (
      <FormattedMessage
        id="components.apps.deployments.deployment-targets-table.DeploymentTargetsTable.retryCountTitle"
  ...
  columnHelper.accessor("latestAttempt", {
    header: () => (
      <FormattedMessage
        id="components.apps.deployments.deployment-targets-table.DeploymentTargetsTable.latestAttemptTitle"
  ...
  columnHelper.accessor("completionTimestamp", {
    header: () => (
      <FormattedMessage
        id="components.apps.deployments.deployment-targets-table.DeploymentTargetsTable.completionTimestampTitle"
