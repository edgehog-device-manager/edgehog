...
const deploymentReadinessMessages = defineMessages({
  READY: {
    id: "components.apps.deployments.deployment-readiness.DeploymentReadiness.ready",
    defaultMessage: "Ready",
  },
  NOT_READY: {
    id: "components.apps.deployments.deployment-readiness.DeploymentReadiness.notReady",
