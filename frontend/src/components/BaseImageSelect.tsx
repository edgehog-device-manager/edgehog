...
import { CreateUpdateCampaign_getBaseImageCollection_Query } from "api/__generated__/CreateUpdateCampaign_getBaseImageCollection_Query.graphql";
...
import {
  BaseImageCollectionRecord,
  GET_BASE_IMAGE_COLLECTION_QUERY,
} from "forms/CreateUpdateCampaign";
...
type BaseImageSelectContentProps = {
  baseImageCollectionQuery: PreloadedQuery<CreateUpdateCampaign_getBaseImageCollection_Query>;
  controllerProps: ControllerProps;
};
...
const BaseImageSelectWrapper = ({
  ...
  const [getBaseImageCollectionQuery, getBaseImageCollection] =
    useQueryLoader<CreateUpdateCampaign_getBaseImageCollection_Query>(
      GET_BASE_IMAGE_COLLECTION_QUERY,
    );
