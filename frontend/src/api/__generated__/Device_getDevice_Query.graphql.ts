...
export type Device_getDevice_QueryResponse = {
    readonly device: {
        ...
        readonly " $fragmentRefs": FragmentRefs<"Device_hardwareInfo" | "Device_location" | "Device_storageUsage" | "Device_systemStatus" | "Device_wifiScanResults" | "Device_batteryStatus">;
    } | null;
};
...
return {
  ...
  "params": {
    "cacheID": "db6a1765b66817485568e99654f0bb60",
    "id": null,
    "metadata": {},
    "name": "Device_getDevice_Query",
    "operationKind": "query",
...
(node as any).hash = 'a74815b3f4b600219bfce7ecc937eb4d';
export default node;
