...
## [0.14.0](https://github.com/edgehog-device-manager/edgehog/compare/v0.13.1...v0.14.0) (2026-09-25)
...
* add advanced options to file download request details ([fd775d9](https://github.com/edgehog-device-manager/edgehog/commit/fd775d97a0a6e00f2eb19cd18bc718195f356086))
* add details column to request history table ([888f619](https://github.com/edgehog-device-manager/edgehog/commit/888f61961fe9a2edc3ff7079dd4e7d51cb4027ac))
...
* allow direct container removal ([03465b7](https://github.com/edgehog-device-manager/edgehog/commit/03465b711f768531d959bbb08b87255af8a39624))
* Allow navigation when key columns are hidden ([#1594](https://github.com/edgehog-device-manager/edgehog/issues/1594)) ([d7d9c7f](https://github.com/edgehog-device-manager/edgehog/commit/d7d9c7f400d20f21dfe3b97590cf051da70960da))
...
* **frontend:** add customizable table column visibility ([3bba8c1](https://github.com/edgehog-device-manager/edgehog/commit/3bba8c17eee0066fbd2718c4a8bb02e13f39ce15))
...
* **frontend:** expand Container forms and details with new fields ([ea7e73e](https://github.com/edgehog-device-manager/edgehog/commit/ea7e73e97a2df460dbe33a164bf16b471af6561b))
...
* **frontend:** update installation flow ([e52874f](https://github.com/edgehog-device-manager/edgehog/commit/e52874f56505f77b7ab05cc024f1d94960ecd3b5))
* **frontend:** use icons for each feature rather than sections ([46bcd4e](https://github.com/edgehog-device-manager/edgehog/commit/46bcd4e0d4e3beab0baa14a89f0df3c864603efd))
...
* clear dependencies when container selection changes in release form ([f1d0f04](https://github.com/edgehog-device-manager/edgehog/commit/f1d0f04566b4536553a244786f529f95c20d7db3))
...
* **frontend:** fix oversized folder icon ([4843c55](https://github.com/edgehog-device-manager/edgehog/commit/4843c554c499d37d397b76b989296515bf0ca9ff))
* **frontend:** update Relay connection on application upgrade ([28119df](https://github.com/edgehog-device-manager/edgehog/commit/28119dfe46a3eed4dcb99a1d6c4bd600c231c132))
...
* improve badge and helper icon styles ([98b0a1d](https://github.com/edgehog-device-manager/edgehog/commit/98b0a1d17fef8fdce83919acfe2b9ea7cc1eb987))
* prevent device page crash on unknown values ([#1574](https://github.com/edgehog-device-manager/edgehog/issues/1574)) ([edefe22](https://github.com/edgehog-device-manager/edgehog/commit/edefe228dbe42467e812fc2441585147ab64fba9))
...
* release 0.14.0 ([#1527](https://github.com/edgehog-device-manager/edgehog/issues/1527)) ([505983d](https://github.com/edgehog-device-manager/edgehog/commit/505983d5cefd367a7574de2403b674b7d7a3f88a))
...
* **frontend:** add UI to edit and delete scheduled campaigns ([bf45c9d](https://github.com/edgehog-device-manager/edgehog/commit/bf45c9df24a6e1eb18244784c21a92df8a06ac11))
* **frontend:** extend scheduled campaign edit functionality ([1ba5ad8](https://github.com/edgehog-device-manager/edgehog/commit/1ba5ad8a8cffa7f950f520a57c7e4015e3e3dd1b))
