...
Using the Edgehog API or its frontend, it is possible to set the same [Maintenance Window](ota_update_concepts.html#maintenance-window) to all devices belonging to a Group.
