...
defmodule Edgehog.Campaigns.Executor.Lazy.Core do
  ...
  """
  # TODO: in the old implementation this function called list_targets_with_pending_ota_operation
  # for update campaigns, see if it should be replaced with list_in_progress_targets or left as it was before
