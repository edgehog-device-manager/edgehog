...
defmodule Edgehog.Campaigns.CampaignMechanism.Helpers do
  ...
  """
  def mark_deployment_as_timed_out!(operation_id, tenant_id) do
  ...
  """
  def subscribe_to_deployment_updates!(operation_id) do
    with {:error, reason} <-
  ...
  ## Returns
    - `:ok`
  """
  def unsubscribe_from_deployment_updates!(operation_id) do
