...
defmodule Edgehog.Devices.Device.Calculations.AstarteInterfaceValue do
  ...
  @available_file_binds Application.compile_env(
                          :edgehog,
                          :astarte_available_file_binds_module,
                          Edgehog.Astarte.Device.AvailableFileBinds
                        )

  @available_env_files Application.compile_env(
                         :edgehog,
                         :astarte_available_env_files_module,
                         Edgehog.Astarte.Device.AvailableEnvFiles
                       )
  ...
  defp value_id_to_fetch_fun(:available_file_binds), do: &@available_file_binds.get/2
  defp value_id_to_fetch_fun(:available_env_files), do: &@available_env_files.get/2
