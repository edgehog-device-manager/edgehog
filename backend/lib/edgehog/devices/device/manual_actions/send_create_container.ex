...
defmodule Edgehog.Devices.Device.ManualActions.SendCreateContainer do
  ...
  def update(changeset, _opts, _context) do
    ...
    with {:ok, env_encoding} <- Ash.load(container, :env_encoding) do
  ...
  defp to_correct_string(:unless_stopped), do: "unless-stopped"
  defp to_correct_string(:on_failure), do: "unless-stopped"
  defp to_correct_string(other), do: to_string(other)
end
