...
defmodule Edgehog.Containers.DeploymentContainerDeployment do
  @moduledoc false
  ...
  actions do
    defaults [:read, :destroy, create: [:deployment_id, :container_deployment_id]]
  end
  ...
  postgres do
    table "deployment_container_deployments"
