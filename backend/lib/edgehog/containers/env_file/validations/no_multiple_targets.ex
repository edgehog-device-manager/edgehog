...
defmodule Edgehog.Containers.EnvFile.Validations.NoMultipleTargets do
  @moduledoc false
  ...
  def validate(changeset, _opts, _context) do
    ...
    case {file_request_id, device_file_id} do
      {{:ok, _}, {:ok, _}} ->
        {:error,
         message:
           "Ambiguous env file setting. either use a file download request id or a device file id."}
