...
defmodule Edgehog.Containers.EnvFile.Storage do
  @moduledoc """
  ...
  def file_path(tenant_id, env_file_id, _file_name \\ nil) do
    "uploads/tenants/#{tenant_id}/env_files/#{env_file_id}/file"
  end
