...
defmodule Edgehog.Containers.Release.Deployment.ReadyAction do
  @moduledoc false
  ...
  relationships do
    belongs_to :deployment, Edgehog.Containers.Release.Deployment do
      allow_nil? false
      attribute_type :uuid
    end

    belongs_to :upgrade_deployment, Edgehog.Containers.Release.Deployment.ReadyAction.Upgrade do
      attribute_type :uuid
    end
  end
