...
defmodule Edgehog.Containers.Network.Deployment.ExecutorSupervisor do
  @moduledoc false
  use DynamicSupervisor

  alias Edgehog.Containers.Network.Deployment
  alias Edgehog.Containers.Network.Deployment.ExecutorRegistry
  ...
  def start_executor!(deployment) do
    ...
    case DynamicSupervisor.start_child(__MODULE__, child_spec) do
      ...
      {:error, reason} ->
        msg =
          "Network Deployment executor for deployment #{deployment.id} failed to start: " <>
            "#{inspect(reason)}"
