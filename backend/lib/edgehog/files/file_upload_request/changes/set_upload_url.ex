...
defmodule Edgehog.Files.FileUploadRequest.Changes.SetUploadUrl do
  ...
  def change(changeset, _opts, context) do
    ...
    if is_nil(file_upload_request_id) do
      Ash.Changeset.add_error(changeset, field: :id, message: "missing file upload request id")
    else
      file_path =
        "uploads/tenants/#{tenant_id}/ephemeral_file_upload_requests/#{file_upload_request_id}/file"

      case Edgehog.Storage.create_presigned_urls(file_path) do
