...
defmodule Edgehog.MixProject do
  ...
  defp deps do
    [
      ...
      {:mimic, "~> 2.3", only: :test},
      {:tesla, "~> 1.18"},
      {:finch, "~> 0.23", override: true},
      {:waffle, "~> 2.0.0", override: true},
      {:req, "~> 0.7"},
      {:envar, "~> 1.1"},
      {:ex_aws, "~> 2.6"},
      {:ex_aws_s3, "~> 2.5"},
      {:azurex,
       github: "edgehog-device-manager/azurex", ref: "1dcd582b6b5ff4fc5e6d0c67af942cc71d7b42ad"},
      {:sweet_xml, "~> 0.7"},
      {:waffle_gcs,
       github: "edgehog-device-manager/waffle_gcs",
       ref: "a98c75cefec9dbdff4b764a7b15605dae5e11676"},
      {:guardian, "~> 2.4"},
      {:jose, "~> 1.11"},
      {:skogsra, "~> 2.5"},
      {:nimble_parsec, "~> 1.4"},
