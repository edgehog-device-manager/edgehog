...
Mimic.copy(Edgehog.Astarte.Device.CreateBind)
...
Mimic.copy(Edgehog.Astarte.Device.AvailableDeviceRequests)
Mimic.copy(Edgehog.Astarte.Device.AvailableFileBinds)
Mimic.copy(Edgehog.Astarte.Device.AvailableDevices)
Mimic.copy(Edgehog.Storage)
Mimic.copy(Edgehog.Files.File.BucketStorage)
Mimic.copy(Edgehog.Config)
...
Mimic.copy(Edgehog.Containers.FileBind.Provisioner)
Mimic.copy(Edgehog.Files.FileDownloadRequest.Provisioner)
Mimic.copy(Edgehog.Containers.Container.Deployment.Provisioner)
Mimic.copy(Edgehog.Containers.Container.Deployment.Orchestrator)
Mimic.copy(Edgehog.Containers.Deployment.Provisioner)
Mimic.copy(Edgehog.Containers.Deployment.Orchestrator)
Mimic.copy(Edgehog.Containers.Deployment.Starter)
Mimic.copy(Edgehog.Containers.Deployment.Starter.Core)
