...
defmodule EdgehogWeb.Schema.Mutation.CreateManualOTAOperationNoExistingBaseImageTest do
  ...
  describe "createManualOtaOperationNoExistingBaseImage mutation" do
  ...
  defp create_ota_operation_mutation(opts) do
    default_document = """
    mutation CreateManualOtaOperationNoExistingBaseImage($input: CreateManualOtaOperationNoExistingBaseImageInput!) {
  ...
  defp extract_error!(result) do
    assert is_nil(result[:data]["createManualOtaOperationNoExistingBaseImage"])
